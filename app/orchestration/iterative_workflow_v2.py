...
from app.orchestration.artifact_saver_v2 import ArtifactSaver
...
from app.orchestration.agent_utils import standardize_agent_name, AGENT_DIRS
    ...
    async def _run_agent(self, agent_name: str, task: str) -> Dict[str, Any]:
        ...
        for msg in result.messages:
            if hasattr(msg, 'source') and hasattr(msg, 'content'):
                if agent_name in msg.source.lower():
                    content = msg.content
                    break
