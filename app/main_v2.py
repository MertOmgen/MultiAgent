...
Examples:
  ...
  python -m app.main --max-iterations 5 "Complex feature..."
    ...
    parser.add_argument(
        "--use-v1",
        action="store_true",
        help="Use original workflow (v1) instead of refactored (v2)"
    )
    ...
    try:
        ...
        if args.use_v1:
            ...
            from app.orchestration.iterative_workflow_v2 import IterativeWorkflowV2
            workflow = IterativeWorkflowV2(max_iterations=args.max_iterations)
        ...
        if args.project:
            print(f"\n📁 Project files: outputs/projects/{args.project}/")
        else:
